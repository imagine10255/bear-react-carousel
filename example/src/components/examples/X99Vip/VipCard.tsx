        ...
        <VipCardRoot>
            <StarGroup>
                {Array.from({length: level}).map((row, index) => {
                    return <StarImage src={isUseOld ? asset('/images/x99_vip/old/star.svg'):
                        asset('/images/x99_vip/star.svg')} key={`star_${level}_${index}`}/>;
                })}
            </StarGroup>

            <Flex column className="gap-1">
                <Flex className="gap-2 align-items-center">
                    <LevelIconImage src={isUseOld ? asset('/images/x99_vip/old/crown.svg'): asset('/images/x99_vip/crown.svg')}/>
                    <LevelName>{levelName}</LevelName>
                </Flex>

                <Flex className="gap-2 align-items-center">
                    <LevelIconImage src={isUseOld ? asset('/images/x99_vip/old/lightning.svg'): asset('/images/x99_vip/lightning.svg')} style={{height: '40px'}}/>
                    <LevelName>
                        <TotalAmount>
                ...
                <Flex className="gap-2 align-items-center">
                    <LevelIconImage src={isUseOld ? asset('/images/x99_vip/old/heart.svg'): asset('/images/x99_vip/heart.svg')}/>
                    <LevelDesc>Valid betting requirements for relegation are {month} months</LevelDesc>
                </Flex>
            </Flex>
